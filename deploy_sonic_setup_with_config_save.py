...
# ============================================================================
SONIC_HOST = "192.168.1.10"       # SONiC device IP address
SSH_USERNAME = "admin"             # SSH username
SSH_PASSWORD = "YourPassword123"   # SSH password
...
def configure_sonic():
    try:
        ...
        # 8. Save configuration to make it persistent
        print('8. Saving configuration...')
        import subprocess
        result = subprocess.run(['sudo', 'config', 'save', '-y'], 
...
def display_configuration_summary():
    ...
    print(f"     - Make changes persistent (config save)")
    print("=" * 70)
    print()
